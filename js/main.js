...
const getStringLocation = () => {
  const latitude = getRandomFloat(Latitude.MIN, Latitude.MAX, DIGITS);
  const longitude = getRandomFloat(Longitude.MIN, Longitude.MAX, DIGITS);
...
const createOffer = () => (
  {
    ...
    location: {
      lat: getRandomFloat(Latitude.MIN, Latitude.MAX, DIGITS),
      lng: getRandomFloat(Longitude.MIN, Longitude.MAX, DIGITS),
    },
  }
);
